...
import type { CreateCounterSchemaType, UpdateCounterSchemaType } from "@/lib/schema/counter"

interface CreatetaskMetricCounterProps {
  control: Control<CreateCounterSchemaType | UpdateCounterSchemaType>
}

const CreatetaskMetricCounter: React.FC<CreatetaskMetricCounterProps> = ({ control }) => {
...
export default CreatetaskMetricCounter